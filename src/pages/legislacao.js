...
const Legislacao = () => (
    <Layout pageInfo={{ pageName: "Legislacao" }}>
        <SEO title="Legislacao" />
        <Container >
            <Row className="justify-content-center my-3">
                <Col className="bg-dark">
                    <h1 className="text-center text-uppercase text-white font-weight-bold">Legislação</h1>
                </Col>
            </Row>
            <Row>
                <Col lg={12}>
                    <h2>Legislação concerniente ao detective privado no Brasil</h2>
                    <p> Documentação Profissional:</p>
            Podem obter informação sobre a Profissão e Legalização dos Detetives Privados: Consultando nossa pagina Web (Legislação) o no site do CONSELHO DOS DETETIVES DO CEARÁ CRD-CE-Brasil ( www.crd-ce.com.br )
            (CRD-CE) Conselho dos Detetives do Ceará (Brasil) é uma Associação de Classe, com Âmbito Nacional, de Direitos Privados, e sem fim Lucrativos, dotada de Personalidade Jurídica, Constituída legalmente, em 2003, Situada e com Privilégio Judicial na Cidade de Fortaleza, Ceará- Brasil.
            Foi criada para: Dar Cursos, Representações Legais, Defesa e Coordenação dos interesses Econômicos e/ou Profissionais, das pessoas físicas ou Jurídicas, que realizem respectivamente, as mesmas Atividades ou Profissões Similares, ligadas a Investigação Privada e/ou Informações Reservadas ou Confidenciais, Comerciais ou Particulares, com o Objetivo de uma extensão Técnico e Professional de seus Filiados, Capacitando -lês, para o Pleno e Correto exercício de seu Trabalho, de maneira a respeitar, as leis atuais, Poderes Públicos e Autoridades Constituídas.
            É responsabilidade Constitucional do CRD-CE a Defesa dos Direitos e Interesses Coletivos ou Individuais de Nossa Categoria, nas questões Judiciais ou Administrativas.
            Desta forma, ou (CRD-CE) Legalmente Constituído, Respalda o Exercício Profissional dos Agentes de Pesquisa (Detetives Privados) devidamente Inscritos nas Seções de Nossa Entidade.
            “O (CRD-CE), Conselho dos Detetives do Ceará (Brasil), e a Única Entidade, (Reconhecida Oficialmente Pela (SSPDS/POLÌCIA-CIVIL). Parecer 107/06 E Parecer 216/2007- ASEJUR. Referencia: SPU 065193660 Processo 07060553-0
            “SECRETÁRIA DA SEGURANÇA PUBLICA DO ESTADO DO CEARÁ”  (CRD-CE-Brasil)
            O Conselho dos Detetives do Ceará , fundado em 2003, tornou-se uma entidade de classe legal em todo o Estado do Ceará, com o advento da Constituição Federal de 1988.
            ...
            Cabe constitucionalmente, ao CRD-CE, restritamente, a defesa dos direitos e interesses coletivos ou individuais da categoria, as questões judiciais ou administrativas.
            Desta forma, o Conselho Regional dos Detetives do Ceará, (CRD-CE), e Primeira e Única Entidade, (Reconhecida Oficialmente Pela (SSPDS/POLÌCIA-CIVIL). Parecer 107/06 E Parecer 216/2007- ASEJUR. Referencia: SPU 065193660 Processo 07060553-0
            “SECRETÁRIA DA SEGURANÇA PUBLICA DO ESTADO DO CEARÁ”
            No país a mais de 5 anos. e legalmente constituído, respalda o exercício profissional do Detetive Particular devidamente inscrito nos CRD's, garantindo o gozo das prerrogativas do Art. 5., incisos XII, XIII, XIV, XVI, XVII, XVIII e XIX da referida Carta Magna.
            ...
            O Conselho Regional dos Detetives do Estado do Ceará , alerta: após a criação do CRD-CE, em 2003, várias outras entidades proliferaram no Brasil, denominadas de Associações, Sindicatos, Centrais Únicas Federais, Conselho Federal, Cadastro Nacional, Ordem dos Detetives e etc., muitas, rapinadoras de Detetives incautos. A verdade é uma só: "Não pode haver outra entidade do mesmo gênero, em atividade paralela, segundo adverte a constituição federal no seu art. 8. Inciso II".
            O CRD-CE, não tem vínculo nenhum com esses indivíduos e entidades Ilegais . No que concerne ao Detetive legalizado, somente há vínculo com os Pertencentes ao CRD-CE.
        </Col>
                <Col lg={12}>
                    <p>
                        A profissão Agente de Informações (Detetive Particular) é amparada por Lei.
                        ADVERTÊNCIA
                        ...
                        Art . 5º Os estabelecimentos autorizados a funcionar fornecerão à Polícia (à Superintendência da Ordem Política e Social e à Chefia do Departamento de Investigações, onde existirem), tôdas as
          ...
          <ul>
                    ...
                    <p> Brasília, em 3 de maio de 1961; 140º da Independência e 73º da República. </p>
                    <p> Jânio Quadros </p>
                    <p>Arthur Bernardes Filho</p>
                    <p>Oscar Pedroso Horta</p>
                </Col>
                <Col lg={12}>
                    <h2>Grampo telefônico é crime</h2>
                    <p>
                        O Artigo. 10 da Lei Federal nº. 9.296 de 24 de Julho de 1996, diz que: Constitui Crime realizar interceptação de comunicações telefônicas, informáticas, tele máticas, ou quebrar segredo de Justiça sem autorização judicial, ou com objetivos não autorizados em LEI.
                        Pena de Reclusão de DOIS a QUATRO anos e Multa.
                        Incorre nas Penas acima descritas , QUEM MANDA OU FAZ O GRAMPO TELEFÔNICO.... SAIBA QUE NÃO PACTUAMOS COM TAIS IRREGULARIDADES.
                        “Um Detetive Profissional NÃO e um Profissional do crime”.
          </p>
                </Col>
            </Row>
        </Container>
